...
export default function TableDemoTwo() {
	...
	const tabs = [
		...
		{ key: "example-four", label: "範例四", content: <TableExampleFour /> },
		{
			key: "example-four-redesign",
			label: "範例四優化",
			content: <TableExampleFourRedesign />,
		},
	];
	...
	return (
		<div className="container mx-auto">
			...
			>
				{/* Tab Triggers */}
				<TabsList className="my-5 grid w-full grid-cols-7 lg:mb-5 bg-zinc-700 p-1 rounded-md text-white">
					{tabs.map((tab) => (
						<TabsTrigger
							key={tab.key}
							className={({ selected }) =>
